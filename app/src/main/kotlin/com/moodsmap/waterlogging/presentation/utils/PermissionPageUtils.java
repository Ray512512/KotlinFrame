...
public class PermissionPageUtils {
    ...
    //自己的项目包名
    private String packageName= App.instance.getPackageName();
    ...
    public void jumpPermissionPage() {
        try {
            ...
            Lg.e(TAG, "jumpPermissionPage --- nickName : " + name);
            switch (name) {
                case "HUAWEI":
                    goHuaWeiMainager();
                    break;
    ...
    private static String getMiuiVersion() {
        String propName = "ro.miui.ui.version.nickName";
        String line;
    ...
    private void goXiaoMiMainager() {
        ...
        Lg.e(TAG,"goMiaoMiMainager --- rom : "+rom);
