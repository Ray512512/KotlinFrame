package com.moodsmap.waterlogging.presentation.kotlinx.extensions.krealmextensions
...
private fun <T : RealmModel> T.performQuery(fieldName : List<String>? = null, order : List<Sort>? = null, query: Query<T>? = null): Single<List<T>> {
    ...
    return Single.create<List<T>>({ emitter ->
        ...
        val realm = com.moodsmap.waterlogging.presentation.kotlinx.extensions.krealmextensions.RealmConfigStore.Companion.fetchConfiguration(javaClass)?.realm() ?: Realm.getDefaultInstance()
