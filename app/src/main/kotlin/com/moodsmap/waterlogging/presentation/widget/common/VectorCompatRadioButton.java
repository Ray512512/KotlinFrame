package com.moodsmap.waterlogging.presentation.widget.common;
...
public class VectorCompatRadioButton extends AppCompatRadioButton {
    ...
    public VectorCompatRadioButton(Context context) {
        this(context, null);
    }

    public VectorCompatRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VectorCompatRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VectorCompatRadioButton);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                dl = a.getDrawable(R.styleable.VectorCompatRadioButton_drawableLeftCompat);
                dt = a.getDrawable(R.styleable.VectorCompatRadioButton_drawableTopCompat);
                dr = a.getDrawable(R.styleable.VectorCompatRadioButton_drawableRightCompat);
                db = a.getDrawable(R.styleable.VectorCompatRadioButton_drawableBottomCompat);
            } else {
                int dlId = a.getResourceId(R.styleable.VectorCompatRadioButton_drawableLeftCompat, -1);
                int dtId = a.getResourceId(R.styleable.VectorCompatRadioButton_drawableTopCompat, -1);
                int drId = a.getResourceId(R.styleable.VectorCompatRadioButton_drawableRightCompat, -1);
                int dbId = a.getResourceId(R.styleable.VectorCompatRadioButton_drawableBottomCompat, -1);
            ...
            isTintDrawableInTextColor = a.getBoolean(R.styleable.VectorCompatRadioButton_tintDrawableInTextColor, false);
            mDrawableCompatColor = a.getColor(R.styleable.VectorCompatRadioButton_drawableCompatColor, 0);
            isDrawableAdjustTextWidth = a.getBoolean(R.styleable.VectorCompatRadioButton_drawableAdjustTextWidth, false);
            isDrawableAdjustTextHeight = a.getBoolean(R.styleable.VectorCompatRadioButton_drawableAdjustTextHeight, false);
            isDrawableAdjustViewWidth = a.getBoolean(R.styleable.VectorCompatRadioButton_drawableAdjustViewWidth, false);
            isDrawableAdjustViewHeight = a.getBoolean(R.styleable.VectorCompatRadioButton_drawableAdjustViewHeight, false);
            mDrawableWidth = a.getDimensionPixelSize(R.styleable.VectorCompatRadioButton_drawableWidth, 0);
            mDrawableHeight = a.getDimensionPixelSize(R.styleable.VectorCompatRadioButton_drawableHeight, 0);
            a.recycle();
