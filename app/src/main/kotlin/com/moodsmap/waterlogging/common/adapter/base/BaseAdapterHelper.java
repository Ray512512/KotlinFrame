package com.moodsmap.waterlogging.common.adapter.base;
...
public class BaseAdapterHelper extends RecyclerView.ViewHolder {
    ...
    /**
     * Sets the on ImgItemClick listener of the view.
     *
     * @param viewId   The view id.
     * @param listener The on ImgItemClick listener;
     * @return The BaseAdapterHelper for chaining.
     */
    ...
    /**
     * Sets the on long ImgItemClick listener of the view.
     *
     * @param viewId   The view id.
     * @param listener The on long ImgItemClick listener;
     * @return The BaseAdapterHelper for chaining.
     */
