package com.moodsmap.waterlogging.view.scrollview;
...
{  
    ...
    public interface overScrollTop{
        void overTop(boolean over);
    }
    private overScrollTop overScrollTop;
    public void setOverScrollTopListener(overScrollTop over){
        overScrollTop=over;
    }

    public boolean isOverScrolled()
    {
        if(overScrollTop!=null){
            overScrollTop.overTop(getScrollY() < child.getPaddingTop());
        }
    ...
    /**
     * Handle scrolling in response to an up or down arrow ImgItemClick.
     *
     * @param direction
