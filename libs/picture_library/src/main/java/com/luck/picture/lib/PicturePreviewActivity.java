    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isCompressCb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                PictureSelectorActivity.isCompress=!isChecked;
                config.isCompress=!isChecked;
                RxBus.getDefault().post(new EventEntity(PictureConfig.UPDATE_FLAG_ISCOMPRESS, -1));
                if(animation!=null){
        ...
        isCompressCb.setChecked(PictureSelectorActivity.isCompress);
        ...
        isCompressLayout.setOnClickListener(new View.OnClickListener() {
            @Override
