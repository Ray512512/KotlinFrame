...
public class ImageGridAdapter extends BaseAdapter {
    ...
    class ViewHolder {
        ...
        void bindData(final Image data){
            ...
            if (imageFile.exists()) {
                // 显示图片
                RequestOptions requestOptions=new RequestOptions().placeholder(R.drawable.mis_default_error).override(mGridWidth,mGridWidth).centerCrop().error(errorDrawable);
                Glide.with(mContext).load(imageFile).apply(requestOptions).into(image);
